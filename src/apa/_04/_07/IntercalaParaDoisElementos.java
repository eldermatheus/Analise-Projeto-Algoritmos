...
public class IntercalaParaDoisElementos {
    ...
    private static Aluno[] intercala(Aluno[] alunos, int inicio, int meio, int fim) {
        ...
        for (int i = 0; i < intercalado.length; ++i) {
            resultado[inicio + i] = intercalado[i];
        }
        return resultado;
    }
